...
export default function GreetSection() {
    return (
        <section style={{ marginBottom: "20px" }}>
            <h1 style={{fontSize: "56px"}}>Welcome to our Platform</h1>
            <p style={{marginBottom:"20px"}}>Delicious Food | Luxuray Room | Best Service</p>
            <button style={{marginInline:"30px", borderRadius:"5px", padding:"5px"}}>Explorer Menu</button>
            <button style={{marginInline:"30px", borderRadius:"5px", padding:"5px"}}>View Room</button>
            <h1 style={{marginTop:"80px", fontSize:"40px"}}>Our service! </h1>
