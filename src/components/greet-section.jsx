...
export default function GreetSection() {
    return (
        <section style={{ marginBottom: "20px", color:"white" }}>
            ...
            <button style={{marginInline:"30px", borderRadius:"5px", padding:"5px",background:"green",padding:"6px 9px", fontWeight:"bold",color:"white"}}>Explorer Menu</button>
            <button style={{marginInline:"30px", borderRadius:"5px", padding:"5px",background:"green",padding:"6px 9px", fontWeight:"bold",color:"white"}}>View Room</button>
